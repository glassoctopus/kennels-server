...
class HandleRequests(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        # function next.
        if resource == "animals":
            asset = create_animal(post_body)
        
        elif resource == "locations":
            asset = create_location(post_body)
            
        elif resource == "employees":
            asset = create_employee(post_body)
            
        elif resource == "customers":
            asset = create_customer(post_body)

        # Encode the new animal and send in response
        self.wfile.write(json.dumps(asset).encode())
